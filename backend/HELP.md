...
* The original package name 'com.finance.backend.transaction-management' is invalid and this project uses 'com.finance.backend.transaction_management' instead.
